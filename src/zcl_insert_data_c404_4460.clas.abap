CLASS zcl_insert_data_c404_4460 DEFINITION
  PUBLIC
  FINAL
  CREATE PUBLIC .
...
CLASS zcl_insert_data_c404_4460 IMPLEMENTATION.
...
*    last_changed_at       : abp_lastchange_tstmpl;
     ...
     data: lt_acc_categ type table of ztb_ac_cat_4460,
           lt_catego    type table of ztb_catego_4460,
           lt_clientes  type table of ztb_cliente_4460,
           lt_clnts_lib type table of ztb_clnt_lb_4460,
           lt_libros    type table of ztb_libros_4460.
...
*    ******* TABLA1 ********
        ...
        delete from ztb_ac_cat_4460.
        insert ztb_ac_cat_4460 from table @lt_acc_categ.
...
*    ******* TABLA2 ********
        ...
        "Delete possible entries; insert new entries
        delete from ztb_catego_4460.
        insert ztb_catego_4460 from table @lt_catego.
...
*    ******* TABLA3 ********
        ...
        "Delete possible entries; insert new entries
        delete from ztb_cliente_4460.
        insert ztb_cliente_4460 from table @lt_clientes.
...
*    ******* TABLA4
        ...
        "Delete possible entries; insert new entries
        delete from ztb_clnt_lb_4460.
        insert ztb_clnt_lb_4460 from table @lt_clnts_lib.
...
*    ******* TABLA5 ********
        ...
        'https://eltinteroeditorial.com/wp-content/uploads/2017/06/c%C3%B3mo-es-el-proceso-de-edici%C3%B3n.jpg' ) ).
        "Delete possible entries; insert new entries
        delete from ztb_libros_4460.
        insert ztb_libros_4460 from table @lt_libros.
